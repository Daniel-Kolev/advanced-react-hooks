...
- useEffect =/= class component lifecycle methods
- don't ignore deps
- don't go into giant useEffects - you lost out on the seperation of concenrs
- you can define functions inside them to simplify logic

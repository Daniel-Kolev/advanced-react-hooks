...
createContext accepts a default value as a first argument (not recommended ->
consuming context without provider is most likely a mistake) If you want to
avoid prop drilling, composition > context
